new CustomApexChart({
  ...
  new CustomApexChart({
    ...
    options: () => ({
      ...
      stroke: { show: !0, width: 2, colors: [ins("secondary-bg")] },
      series: [
        { name: "iPhone 16", data: [44, 55, 41, 64, 22, 43, 21] },
        { name: "iPhone 16 Pro", data: [53, 32, 33, 52, 13, 44, 32] },
      ],
      xaxis: {
  ...
  new CustomApexChart({
    ...
    options: () => ({
      ...
      fill: { opacity: 1 },
      states: { hover: { filter: "none" } },
      legend: { position: "top", horizontalAlign: "center", offsetY: -7 },
      grid: {
        borderColor: [ins("border-color")],
        padding: { top: -30, right: 0, bottom: -15, left: 0 },
      },
    }),
  }),
  new CustomApexChart({
      ...
      series: [
        {
          name: "Q1 Budget",
          group: "budget",
          data: [44e3, 55e3, 41e3, 67e3, 22e3],
        },
        {
          name: "Q1 Actual",
          group: "actual",
          data: [48e3, 5e4, 4e4, 65e3, 25e3],
        },
        {
          name: "Q2 Budget",
          group: "budget",
          data: [13e3, 36e3, 2e4, 8e3, 13e3],
        },
        {
          name: "Q2 Actual",
          group: "actual",
          data: [2e4, 4e4, 25e3, 1e4, 12e3],
        },
      ],
  ...
  new CustomApexChart({
    ...
    options: () => ({
      ...
      yaxis: {
        min: -5,
        max: 5,
        title: { text: "Age", style: { fontSize: "14px", fontWeight: 600 } },
      },
      tooltip: {
        shared: !1,
        x: {
        ...
        xaxis: [
          {
            ...
            label: {
              borderColor: ins("success"),
              style: { color: "#fff", background: ins("success") },
              text: "X annotation",
            },
          },
        ],
...
let labels = Array.apply(null, { length: 39 }).map(function (e, t) {
  return t + 1;
});
new CustomApexChart({
  ...
  options: () => ({
    ...
    series: [
      {
        ...
        data: [
          ...
          11, 12, 13, 14, 16, 14, 15, 17, 19, 21, 12, 12, 11, 12, 13, 14, 16,
          14, 15, 17, 19, 21,
        ],
      },
    ],
    ...
    yaxis: {
      ...
      axisTicks: { show: !1 },
      labels: { show: !1 },
      title: { text: "Weight", style: { fontSize: "14px", fontWeight: 600 } },
    },

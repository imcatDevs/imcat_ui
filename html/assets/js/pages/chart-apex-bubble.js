...
new CustomApexChart({
  ...
  new CustomApexChart({
    ...
    options: () => ({
      series: [
        { name: "Social Campaigns", data: [[150, 300, 35]] },
        { name: "Email Newsletter", data: [[250, 350, 35]] },
        { name: "TV Campaign", data: [[350, 450, 30]] },
        { name: "Google Ads", data: [[450, 250, 25]] },
        { name: "Courses", data: [[500, 500, 30]] },
        { name: "Radio", data: [[600, 250, 28]] },
      ],
      chart: {
        fontFamily: "inherit",
        type: "bubble",
      ...
      dataLabels: { enabled: !1 },
      fill: { opacity: 0.8 },
      xaxis: { type: "numeric", tickAmount: 7, min: 0, max: 700 },
      yaxis: { tickAmount: 7, min: 0, max: 700 },
      tooltip: {
        y: {

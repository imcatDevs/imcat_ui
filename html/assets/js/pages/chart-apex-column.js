...
new CustomApexChart({
  ...
  options: () => ({
    ...
    grid: {
      ...
      padding: { top: -20, right: 0, bottom: -5, left: 5 },
    },
    tooltip: {
      y: {
  ...
  new CustomApexChart({
    ...
    options: () => ({
      ...
      dataLabels: {
        ...
        offsetY: -25,
        style: { fontSize: "12px", colors: [ins("body-color")] },
      },
      ...
      title: {
        ...
        offsetY: 330,
        align: "center",
        style: { color: ins("body-color"), fontSize: "14px", fontWeight: 500 },
      },
      grid: {
        row: { colors: ["transparent", "transparent"], opacity: 0.2 },
        borderColor: [ins("border-color")],
  ...
  new CustomApexChart({
    ...
    options: () => ({
      ...
      series: [
        { name: "iPhone 16", data: [65, 59, 80, 81, 56, 55, 40, 72] },
        { name: "iPhone 16 Pro", data: [28, 48, 40, 19, 86, 27, 90, 50] },
        { name: "iPhone 15", data: [35, 29, 50, 45, 60, 33, 38, 47] },
      ],
      xaxis: {
        categories: [
          "2023 Q1",
  ...
  new CustomApexChart({
    ...
    options: () => ({
      ...
      series: [
        { name: "iPhone 16", data: [44, 55, 41, 67, 22, 43, 21, 49] },
        { name: "iPhone 16 Pro", data: [13, 23, 20, 8, 13, 27, 33, 12] },
        { name: "iPhone 15", data: [11, 17, 15, 15, 21, 14, 15, 13] },
      ],
      xaxis: {
        categories: [
          "2023 Q1",
  ...
  new CustomApexChart({
    ...
    options: () => ({
      ...
      colors: [
        ins("primary-rgb", 0.7),
        ins("primary"),
        ins("secondary-rgb", 0.7),
        ins("secondary"),
      ],
      yaxis: { labels: { formatter: (e) => e / 1e3 + "K", offsetX: -10 } },
      legend: { position: "top", horizontalAlign: "center", offsetY: -8 },
      grid: {
        borderColor: [ins("border-color")],
        padding: { top: -20, right: -30, bottom: -5, left: 5 },
      },
    }),
  }),
  new CustomApexChart({
    ...
    options: () => ({
      ...
      grid: {
        ...
        yaxis: { lines: { show: !1 } },
        borderColor: [ins("border-color")],
        padding: { top: -20, right: 0, bottom: -15, left: 5 },
      },
      colors: [ins("primary"), ins("secondary")],
      xaxis: {
        tickPlacement: "on",
        axisBorder: { show: !0, color: ins("border-color") },
        axisTicks: { show: !0, color: ins("border-color") },
      },
      yaxis: { labels: { offsetX: -10 } },
    }),
  }),
  new CustomApexChart({
    ...
    options: () => ({
      ...
      legend: {
        ...
        markers: { fillColors: [ins("primary"), ins("secondary")] },
      },
      grid: {
        borderColor: [ins("border-color")],
        padding: { top: -20, right: 0, bottom: -5, left: 0 },
  ...
  new CustomApexChart({
    ...
    options: () => ({
      ...
      grid: {
        borderColor: [ins("border-color")],
        padding: { top: -20, right: 0, bottom: -15, left: 0 },
      },
    }),
  }),
  new CustomApexChart({
        ...
        points: [
          {
            ...
            label: {
              ...
              offsetY: 0,
              style: { color: "#fff", background: ins("secondary") },
    ...
    options: () => ({
      ...
      plotOptions: {
        bar: {
          colors: {
            ranges: [
              { from: -100, to: -46, color: ins("danger") },
              { from: -45, to: 0, color: ins("warning") },
            ],
          },
          columnWidth: "80%",
          borderRadius: 6,
      ...
      yaxis: {
        title: { text: "Growth", style: { fontSize: "14px", fontWeight: 500 } },
        labels: {
          formatter: function (e) {
            return e.toFixed(0) + "%";
          },
  ...
  new CustomApexChart({
    ...
    options: () => ({
      ...
      grid: {
        borderColor: [ins("border-color")],
        padding: { top: -20, right: 10, bottom: -8, left: 10 },
      },
    }),
  }),
  new CustomApexChart({
...
function makeData() {
  ...
  let o = ["primary", "secondary", "info", "danger", "warning", "success"];
  return e.map((e, t) => ({
    x: String(2019 + t),
    y: e.y,
    colorToken: o[t],
...
function updateQuarterChart(e, t) {
  var o = e.w.globals.selectedDataPoints[0];
  let r = e.w.config.series[0],
    a = [],
    s = [];
  o?.forEach((e) => {
    e = r.data[e];
    a.push({ name: e.x, data: e.quarters }), s.push(ins(e.colorToken));
  }),
...
let getYearlyOptions = () => {
    var e = makeData(),
      t = e.map((e) => ins(e.colorToken));
    return {
      series: [{ data: e }],
      chart: {
        id: "barYear",
        ...
        events: {
          dataPointSelection: function (e, t, o) {
            ...
            1 !== o.selectedDataPoints[0].length ||
              ...
              (a.classList.add("chart-quarter-activated"),
              r.classList.add("active")),
              updateQuarterChart(t, "barQuarter"),
              0 === o.selectedDataPoints[0].length &&
                (a.classList.remove("chart-quarter-activated"),
      ...
      dataLabels: {
        ...
        textAnchor: "none",
        style: { colors: ["#fff"] },
        formatter: (e, t) => t.w.globals.labels[t.dataPointIndex],
        offsetX: 10,
      ...
      tooltip: {
        x: { show: !1 },
        y: {
          title: { formatter: (e, t) => t.w.globals.labels[t.dataPointIndex] },
        },
      },
      title: {
        text: "Yearly Results",
  ...
  yearChart = document.getElementById("chart-year"),
  quarterChart = document.getElementById("chart-quarter");
if (yearChart && quarterChart) {
  let t = new ApexCharts(yearChart, getYearlyOptions()),
    e = (t.render(), new ApexCharts(quarterChart, getQuarterlyOptions())),
    o =
      (e.render(),
      t.addEventListener("dataPointSelection", function (e, t, o) {
        var r = document.querySelector("#chart-quarter"),
          a = document.querySelector("#chart-year");
        1 !== o.selectedDataPoints[0].length ||
          r.classList.contains("active") ||
      ...
      t.addEventListener("updated", function (e) {
        updateQuarterChart(e, "barQuarter");
      }),
      document.querySelector("#model").addEventListener("change", function (e) {
        t.updateSeries([{ data: makeData() }]);
      }),
      new MutationObserver(() => {
        let e = t.w.globals.selectedDataPoints?.[0] || [];
        t.updateOptions(getYearlyOptions()),
          setTimeout(() => {
            0 < e.length
              ? (e.forEach((e) => t.toggleDataPointSelection(e)),
                updateQuarterChart(t, "barQuarter"),
                document
                  .querySelector("#chart-year")
                  .classList.add("chart-quarter-activated"),
                document
                  .querySelector("#chart-quarter")
                  .classList.add("active"))
              : (document
                  .querySelector("#chart-year")
                  .classList.remove("chart-quarter-activated"),
                document
                  .querySelector("#chart-quarter")

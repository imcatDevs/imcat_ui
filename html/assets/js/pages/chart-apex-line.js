...
new CustomApexChart({
  ...
  options: () => ({
    ...
    series: [{ name: "Revenue", data: [12, 28, 18, 34, 42, 39, 48, 55, 63] }],
    grid: {
  ...
  new CustomApexChart({
    ...
    options: () => ({
      ...
      dataLabels: {
        ...
        background: { enabled: !0, padding: 8, borderRadius: 4 },
        offsetY: 3,
      },
      stroke: { width: [2, 2], curve: "smooth" },
      series: [
        { name: "Revenue - 2024", data: [45, 52, 48, 58, 63, 72, 80] },
        { name: "Expenses - 2024", data: [25, 35, 32, 40, 38, 36, 34] },
      ],
      grid: {
        row: { colors: ["transparent", "transparent"], opacity: 0.2 },
        borderColor: [ins("border-color")],
...
let userGrowthData = [
    [new Date("2024-02-01").getTime(), 42e5],
    [new Date("2024-02-02").getTime(), 43e5],
    [new Date("2024-02-03").getTime(), 412e4],
    [new Date("2024-02-04").getTime(), 44e5],
    [new Date("2024-02-05").getTime(), 45e5],
    [new Date("2024-02-06").getTime(), 46e5],
    [new Date("2024-02-07").getTime(), 438e4],
    [new Date("2024-02-08").getTime(), 445e4],
    [new Date("2024-02-09").getTime(), 47e5],
    [new Date("2024-02-10").getTime(), 465e4],
    [new Date("2024-02-11").getTime(), 485e4],
    [new Date("2024-02-12").getTime(), 47e5],
    [new Date("2024-02-13").getTime(), 488e4],
    [new Date("2024-02-14").getTime(), 495e4],
    [new Date("2024-02-15").getTime(), 51e5],
    [new Date("2024-02-16").getTime(), 505e4],
    [new Date("2024-02-17").getTime(), 498e4],
    [new Date("2024-02-18").getTime(), 52e5],
    [new Date("2024-02-19").getTime(), 53e5],
    [new Date("2024-02-20").getTime(), 518e4],
    [new Date("2024-02-21").getTime(), 55e5],
    [new Date("2024-02-22").getTime(), 54e5],
    [new Date("2024-02-23").getTime(), 552e4],
    [new Date("2024-02-24").getTime(), 565e4],
    [new Date("2024-02-25").getTime(), 58e5],
  ],
  common =
    (new CustomApexChart({
      ...
      options: () => ({
        ...
        plotOptions: { line: { curve: "straight" } },
        dataLabels: { enabled: !1 },
        stroke: { width: [3] },
        series: [{ name: "User Growth", data: userGrowthData }],
        ...
        series: [
          {
            ...
            data: [
              ...
              { x: new Date("2024-10-15").getTime(), y: 4e3 },
            ],
          },
        ],
        xaxis: { type: "datetime" },
        ...
        series: [
          {
            name: "Followers",
            data: [
              3, 5, 9, 12, 18, 25, 21, 17, 13, 19, 23, 16, 20, 22, 19, 15, 11,
              14,
            ],
          },
        ],
    ...
    new CustomApexChart({
      ...
      options: () => ({
        ...
        dataLabels: { enabled: !1 },
        stroke: { width: [3, 5, 3], curve: "straight", dashArray: [0, 8, 5] },
        series: [
          {
            name: "Charging Time",
        ...
        tooltip: {
          y: {
            title: {
              formatter: function (e) {
                return "Charging Time" === e
                  ? "Charging Time (mins)"
                  : "Energy Delivered" === e
                  ? "Energy Delivered (kWh)"
                  : "Sessions Completed" === e
                  ? "Sessions"
                  : e;
              },
            },
        ...
        grid: { borderColor: [ins("border-color")] },
        legend: { offsetY: 7 },
      }),
    }),
    new CustomApexChart({
      ...
      options: () => ({
        chart: { type: "line", height: 360, toolbar: { show: !1 } },
        stroke: { curve: "stepline" },
        dataLabels: { enabled: !1 },
        series: [{ data: [120, 115, 130, 90, 70, 95, 85, 75, 140, 140, 125] }],
        colors: [ins("purple")],
        markers: { hover: { sizeOffset: 4 } },
        grid: { padding: { right: 20 } },
      }),
    }),
    generateDayWiseTimeSeries(new Date("01 Jan 2024").getTime(), 185, {
      min: 40,
      max: 90,
    })),
  lastDate =
    ...
    0),
  data = generateDayWiseTimeSeries(new Date("11 May 2024 GMT").getTime(), 10, {
    min: 10,
    max: 90,
  });
function getNewSeries(e, t) {
  e += 864e5;
  (lastDate = e),
    data.push([e, Math.floor(Math.random() * (t.max - t.min + 1)) + t.min]);
}
function resetData() {
  data = data.slice(data.length - 10, data.length);
}
lastDate = data[data.length - 1][0];
let realtimeChart = new CustomApexChart({
...
window.setInterval(() => {
  getNewSeries(lastDate, { min: 10, max: 90 }),
    realtimeChart.chart.updateSeries([{ data: data }]);
}, 2e3),
  window.setInterval(() => {
    resetData(), realtimeChart.chart.updateSeries([{ data: data }], !1, !0);
  }, 6e4);

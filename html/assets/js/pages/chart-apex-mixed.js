new CustomApexChart({
  ...
  options: () => ({
    ...
    legend: { offsetY: 5 },
    grid: { borderColor: [ins("border-color")], padding: { right: 20 } },
  }),
}),
  new CustomApexChart({
    ...
    options: () => ({
      ...
      yaxis: [
        {
          axisTicks: { show: !0 },
          axisBorder: { show: !0, color: ins("primary") },
          title: {
        ...
        {
          axisTicks: { show: !0 },
          axisBorder: { show: !0, color: ins("secondary") },
          labels: { offsetX: 0 },
          offsetX: -5,
          title: {
        ...
        },
        {
          opposite: !0,
          axisTicks: { show: !0 },
          axisBorder: { show: !0, color: ins("danger") },
          offsetX: 5,
          title: {
      ...
      series: [
        {
          ...
          type: "area",
          data: [
            4200, 5e3, 3100, 4800, 3900, 5100, 4300, 4700, 4500, 4900, 4600,
          ],
        },
        {
          name: "Avg Heart Rate",

new CustomApexChart({
  ...
  new CustomApexChart({
    ...
    options: () => ({
      ...
      fill: {
        type: "image",
        image: { src: ["assets/images/stock/small-6.jpg"] },
      },
      plotOptions: { radialBar: { hollow: { size: "70%" } } },
      series: [82],
      stroke: { lineCap: "round" },
      labels: ["Portfolio Growth"],
      grid: { padding: { bottom: -5, top: -5 } },
      responsive: [{ breakpoint: 380, options: { chart: { height: 280 } } }],
    }),
  });
let strokedGuageRadialChart = new CustomApexChart({
  ...
  options: () => ({
    ...
    plotOptions: {
      radialBar: {
        ...
        endAngle: 135,
        dataLabels: {
          name: { fontSize: "14px", fontWeight: 500, offsetY: 120 },
          value: {
            offsetY: 76,
            fontSize: "22px",
            color: void 0,
...
new CustomApexChart({
  ...
  options: () => ({
    chart: { height: 330, type: "radialBar", toolbar: { show: !1 } },
    plotOptions: {
      radialBar: {
        startAngle: -135,
        endAngle: 225,
        ...
        dataLabels: {
          show: !0,
          showOn: "always",
          name: { offsetY: -10, show: !0, fontSize: "14px", fontWeight: 500 },
          value: {
            show: !0,
            formatter: function (e) {
              return parseInt(e);

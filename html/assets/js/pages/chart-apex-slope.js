new CustomApexChart({
  ...
  options: () => ({
    ...
    chart: { height: 350, width: "100%", type: "line", toolbar: { show: !1 } },
    plotOptions: { line: { isSlopeChart: !0 } },
    xaxis: { labels: { style: { fontSize: "14px", fontWeight: 500 } } },
  }),
}),
  new CustomApexChart({
    ...
    options: () => ({
      ...
      chart: { height: 350, width: 600, type: "line" },
      colors: [ins("secondary"), ins("purple"), ins("info"), ins("warning")],
      plotOptions: { line: { isSlopeChart: !0 } },
      tooltip: { followCursor: !0, intersect: !1, shared: !0 },
      dataLabels: {
        background: { enabled: !0 },
        formatter(e, s) {
          s = s.w.config.series[s.seriesIndex].name;
          return null !== e ? s : "";
        },
      },
      yaxis: { show: !0, labels: { show: !0 } },
      xaxis: {
        position: "bottom",

...
let sparkDataVisits = [
    120, 135, 160, 180, 170, 145, 190, 210, 185, 195, 220, 240, 230, 250, 270,
    265, 280, 300, 310, 305, 320, 330, 345, 360,
  ],
  sparkDataViews = [
    500, 540, 520, 560, 580, 610, 590, 600, 630, 660, 640, 650, 670, 680, 700,
    720, 740, 760, 750, 770, 790, 810, 830, 850,
  ],
  sparkDataBounce = [
    45, 42, 40, 39, 38, 37, 35, 34, 36, 33, 32, 31, 30, 29, 28, 27, 27, 26, 25,
    24, 24, 23, 22, 21,
  ];
new CustomApexChart({
  selector: "#spark1",
  options: () => ({
    ...
    fill: { opacity: 0.2 },
    series: [{ name: "Unique Visitors", data: sparkDataVisits }],
    colors: [ins("primary")],
    yaxis: { min: 0 },
    title: {
      text: "12,520",
  ...
  new CustomApexChart({
    ...
    options: () => ({
      ...
      stroke: { width: 2, curve: "straight" },
      fill: { opacity: 0.2 },
      series: [{ name: "Page Views", data: sparkDataViews }],
  ...
  new CustomApexChart({
    ...
    options: () => ({
      ...
      stroke: { width: 2, curve: "straight" },
      fill: { opacity: 0.2 },
      series: [{ name: "Bounce Rate", data: sparkDataBounce }],
      colors: [ins("danger")],

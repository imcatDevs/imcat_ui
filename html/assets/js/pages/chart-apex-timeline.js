      ...
      series: [
        {
          ...
          data: [
            ...
            },
            {
              x: "Transit",
              y: [
                new Date("2024-10-03").getTime(),
                new Date("2024-10-07").getTime(),
              ],
            },
            {
              x: "Delivered",
              y: [
                new Date("2024-10-08").getTime(),
                new Date("2024-10-09").getTime(),
              ],
            },
          ],
        },
          ...
          data: [
            {
              ...
              y: [
                ...
                new Date("2024-08-03").getTime(),
              ],
            },
            {
              x: "Development",
              y: [
                new Date("2024-08-04").getTime(),
                new Date("2024-08-09").getTime(),
              ],
            },
            {
              x: "Testing",
              y: [
                new Date("2024-08-10").getTime(),
            ...
            },
            {
              x: "Testing",
              y: [
                new Date("2024-08-16").getTime(),
                new Date("2024-08-18").getTime(),
              ],
            },
            {
              x: "Release Prep",
        ...
        },
        {
          ...
          data: [
            ...
            },
            {
              x: "Development",
              y: [
                new Date("2024-08-06").getTime(),
                new Date("2024-08-11").getTime(),
              ],
            },
            {
              x: "Testing",
          ...
          data: [
            {
              x: "Operations",
              y: [
                new Date(2022, 3, 16).getTime(),
                new Date(2022, 6, 30).getTime(),
              ],
            },
            {
              x: "Finance",

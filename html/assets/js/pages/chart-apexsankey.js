...
function renderSankeyChart(e, t, a) {
  e = document.getElementById(e);
  e && new ApexSankey(e, a).render(t);
}
renderSankeyChart(
  "basic-sankey",
  {
...
let appFlowData = {
  ...
  edgeData =
    (renderSankeyChart("node-sankey", appFlowData, {
      width: "100%",
      height: 400,
      fontFamily: fontFamily,
      fontSize: "14px",
      ...
      nodeWidth: 5,
      nodeBorderWidth: 2,
      nodeBorderColor: ins("border-color"),
      fontColor: ins("light-text-emphasis"),
      edgeGradientFill: !1,
      canvasStyle: "none",
    }),
  ...
  fontData =
    (renderSankeyChart("edge-sankey", edgeData, {
      width: "100%",
      height: 400,
      nodeWidth: 20,
      fontFamily: fontFamily,
...
renderSankeyChart("font-sankey", fontData, {
  width: "100%",
  height: 400,
  nodeWidth: 10,
  fontFamily: fontFamily,

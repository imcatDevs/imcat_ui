...
function verticalNodeTemplate(e) {
  return `
...
function renderApexTree(e, s, a) {
  e = document.getElementById(e);
  e && new ApexTree(e, s).render(a);
}
let data1 = {
    id: "Lucas_Alex",
    data: { name: "Lucas Alex", imageURL: "assets/images/users/user-1.jpg" },
    options: { nodeBGColor: ins("primary-rgb", 0.5) },
    children: [
      {
        id: "Alex_Lee",
        data: { name: "Alex Lee", imageURL: "assets/images/users/user-3.jpg" },
        options: { nodeBGColor: ins("danger-rgb", 0.5) },
        children: [
          {
            id: "Mia_Patel",
            data: {
            ...
            options: { nodeBGColor: ins("info-rgb", 0.5) },
          },
          {
            id: "Ryan_Clark",
            data: {
      ...
      {
        id: "Leo_Kim",
        data: { name: "Leo Kim", imageURL: "assets/images/users/user-6.jpg" },
        options: { nodeBGColor: ins("danger-rgb", 0.5) },
        children: [
          {
            id: "Ava_Jones",
            ...
            options: { nodeBGColor: ins("purple-rgb", 0.5) },
          },
          {
            id: "Maya_Gupta",
            data: {
      ...
      {
        id: "Lily_Chen",
        data: { name: "Lily Chen", imageURL: "assets/images/users/user-4.jpg" },
        options: { nodeBGColor: ins("danger-rgb", 0.5) },
        children: [
          {
            id: "Jake_Scott",
            ...
            options: { nodeBGColor: ins("secondary-rgb", 0.5) },
          },
        ],
      },
      {
        id: "Max_Ruiz",
        data: { name: "Max Ruiz", imageURL: "assets/images/users/user-8.jpg" },
        options: { nodeBGColor: ins("danger-rgb", 0.5) },
      },
    ],
  },
  data2 =
    (renderApexTree(
      "right-to-left",
      { ...sharedOptions, direction: "right" },
      data1
    ),
    renderApexTree(
      "bottom-tree",
      { ...sharedOptions, direction: "bottom" },
      data1
    ),
    {
      id: "ms",

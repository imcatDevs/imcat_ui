...
document.addEventListener("DOMContentLoaded", () => {
  var l = document.getElementById("datatables-javascript-source");
  l &&
    new DataTable(l, {
      columns: [
        { title: "company" },
        ...
        {
          title: "status",
          render: function (l, a, o) {
            return `<span class="badge badge-label ${
              "Bullish" === l ? "badge-soft-success" : "badge-soft-danger"
            }">${l}</span>`;
          },
        },
      ],

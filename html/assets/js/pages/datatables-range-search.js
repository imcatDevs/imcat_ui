document.addEventListener("DOMContentLoaded", function () {
  var t = document.getElementById("range-search-data");
  if (t) {
    let e = new DataTable(t, {
    ...
    t = document.querySelector(".filter-range");
    if (t) {
      t.innerHTML = `
      ...
      let n = document.getElementById("min"),
        r = document.getElementById("max");
      e.search.fixed("range", function (e, t) {
        var a = parseFloat(n.value) || NaN,
          i = parseFloat(r.value) || NaN,
          t = (t[2] || "").replace(/[^0-9.]/g, ""),
          t = parseFloat(t) || 0;
        return (
          (isNaN(a) && isNaN(i)) ||
        ...
        n.addEventListener("input", () => e.draw()),
        r.addEventListener("input", () => e.draw());
    }
  }
});

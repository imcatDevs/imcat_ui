document.addEventListener("DOMContentLoaded", function () {
  var e = document.getElementById("show-hide-column");
  if (e) {
    let n = new DataTable(e, {
      responsive: !0,
    ...
    var t,
      ...
      o = document.querySelector(".columnToggleWrapper");
    o &&
      (((t = document.createElement("div")).className = "dropdown"),
      (t.innerHTML = `
    ...
    `),
      ...
      document
        ...
        .addEventListener("change", function (e) {
          var t;
          e.target.classList.contains("toggle-vis") &&
            ((t = parseInt(e.target.dataset.column, 10)),
            n.column(t).visible(e.target.checked));
        }));
  }
});

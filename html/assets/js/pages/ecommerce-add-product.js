  ...
  init() {
    ...
    "undefined" == typeof Dropzone
      ...
      : ((Dropzone.autoDiscover = !1),
        (i = document.querySelectorAll('[data-plugin="dropzone"]')) &&
          i.forEach((i) => {
            var e = i.getAttribute("action") || "/",
              t = i.dataset.previewsContainer,
              l = i.dataset.uploadPreviewTemplate,
              e = { url: e, acceptedFiles: "image/*" };
            t && (e.previewsContainer = t),
              l &&
                (t = document.querySelector(l)) &&
                (e.previewTemplate = t.innerHTML);
            try {
              new Dropzone(i, e);
            } catch (i) {
              console.error("Dropzone initialization failed:", i);
            }
          }));
  }
}

function generateRandomData(e, t, a) {
  return Array.from(
    { length: e },
...
new CustomApexChart({
  ...
  options: () => ({
    series: [
      { name: "Orders", type: "area", data: generateRandomData(12, 40, 100) },
      {
        name: "Earnings",
        type: "bar",
        data: generateRandomData(12, 70, 150).map((e) => (1.1 * e).toFixed(2)),
      },
      { name: "Refunds", type: "line", data: generateRandomData(12, 3, 12) },
    ],
    ...
    plotOptions: {
      bar: { columnWidth: "30%", barHeight: "70%", borderRadius: 5 },
    },

let defaultButtonClasses = {
  ...
  bindAlert = (t, e) => {
    ...
    t && t.addEventListener("click", () => showAlert(e));
  },
  bindPositionalAlert = (t, e) => {
    t = document.getElementById(t);
    t &&
      t.addEventListener("click", () => {
        Swal.fire({ position: e, ...successToastConfig });
      });
  },
  confirmBtn =
    ...
    document.getElementById("sweetalert-confirm-button")),
  paramsBtn =
    (confirmBtn &&
  ...
  closeButton =
    ...
    document.getElementById("sweetalert-close")),
  ajaxBtn =
    (closeButton &&
      closeButton.addEventListener("click", () => {
        ...
        Swal.fire({
          ...
          didOpen: () => {
            Swal.showLoading(),
              (t = setInterval(() => {
                var t = Swal.getHtmlContainer()?.querySelector("b");
                t && (t.textContent = Math.ceil(Swal.getTimerLeft() / 1e3));
              }, 100));
          },
    ...
    Swal.fire({
      ...
      preConfirm: (n) =>
        new Promise((t, e) => {
          setTimeout(() => {
            "taken@example.com" === n
              ? e("This email is already registered.")
              : t(n);
          }, 1500);
        }),
      allowOutsideClick: !1,

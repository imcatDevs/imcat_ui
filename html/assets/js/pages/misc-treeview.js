class TreeView {
    ...
    this.initTree("#jstree-1", { types: this.defaultTypes }),
          ...
          data: [
            {
              ...
              children: [
                { text: "Item initially selected", state: { selected: !0 } },
                {
                  text: "Custom feedback icon",
                  icon: "ti ti-message-circle fs-lg text-danger",
                },
                {
                ...
                },
                {
                  ...
                  icon: "ti ti-file-text fs-lg text-warning",
                },
                {
                ...
                { text: "New added item", icon: "ti ti-plus fs-lg text-info" },
                {
                  ...
                  icon: "ti ti-download fs-lg text-primary",
                },
              ],
            },
            {
              ...
              children: [
                {
                  ...
                  icon: "ti ti-briefcase fs-lg text-warning",
                },
                {
                  text: "Category item 2",
                  icon: "ti ti-server fs-lg text-success",
                },
                {
                  text: "Category item 3",
                  icon: "ti ti-lock fs-lg text-danger",
                },
              ],
            },
      ...
      this.initTree("#jstree-6", {
        ...
        core: {
          ...
          themes: { responsive: !1 },
          data: {
            url: (t) => (t.id, "assets/data/treeview-data.json"),
            data: (t) => ({ id: t.id }),
          },
        },
        state: { key: "demo3" },
  ...
  initTree(t, e) {
    ...
    t &&
      $(t).jstree({
        core: { themes: { responsive: !1 }, ...(e.core || {}) },
        plugins: e.plugins || ["types"],
        types: e.types || this.defaultTypes,
        ...(e.state && { state: e.state }),
      });
  }
  initSelectableLinks(t) {
    t = document.querySelector(t);
    t &&
      $(t).on("select_node.jstree", function (t, e) {
        var i,
          e = document.querySelector(`#${e.selected} a`);
        if (e)
          return (
      ...
      },
      {
        ...
        children: [
          ...
          },
          {
            ...
            icon: "ti ti-pencil fs-lg text-secondary",
          },
        ],
      },
    ];
    ...
    return [
      {
        ...
        children: [
          {
            text: "Dashboard",
            icon: "ti ti-layout-dashboard text-success fs-lg",
          },
          {
            text: "Reports",
            ...
            children: [
              {
                text: "Annual Report",
                icon: "ti ti-file-description text-warning fs-lg",
              },
              {
                text: "Monthly Report",
                icon: "ti ti-file-analytics text-secondary fs-lg",
              },
            ],
          },
          {
